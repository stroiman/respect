...
var Respect_ctx$Stroimanrespect    = require("./Respect_ctx.js");
var Respect_domain$Stroimanrespect = require("./Respect_domain.js");
  ...
  while(true) {
    ...
    switch (operation.tag | 0) {
      case 0 : 
          ...
          _metadata = Curry._3(Respect_ctx$Stroimanrespect.ContextMap[/* add */3], match[0], match[1], metadata);
          _operation = operation[1];
          continue ;
          case 1 : 
          var init = Respect_domain$Stroimanrespect.ExampleGroup[/* empty */0];
          ...
          var newChild = List.fold_left((function (grp, op) {
                  return applyOperation(op, grp, Respect_ctx$Stroimanrespect.ContextMap[/* empty */0]);
                }), initial, operation[1]);
      ...
      case 3 : 
          return Respect_domain$Stroimanrespect.ExampleGroup[/* addSetup */3](/* Setup */[operation[0]], context);
...
function applyOperation$1(operation, context) {
  return applyOperation(operation, context, Respect_ctx$Stroimanrespect.ContextMap[/* empty */0]);
}

var rootContext = [Respect_domain$Stroimanrespect.ExampleGroup[/* empty */0]];
