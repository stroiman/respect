...
function bind(_, _$1, callbacks) {
  var errorCB = callbacks[1];
  try {
    return /* () */0;
  }
  catch (raw_x){
  ...
  if (!class_tables[0]) {
    ...
    CamlinternalOO.set_methods($$class, /* array */[
          ...
          (function (self$1, matcher, don) {
              var x = Caml_oo_curry.js2(102, 2, matcher, Curry._1(self$1[0][actual$1], self$1));
              var fs = function (param) {
          ...
          (function (self$2, actual) {
              if (Caml_obj.caml_equal(actual, Curry._1(self$2[0][expected$1], self$2))) {
                ...
                return (function (param) {
                    return $$return(partial_arg, param);
                  });
              } else {
                var partial_arg$1 = /* MatchFailure */Block.__(1, [actual]);
                return (function (param) {
                    return $$return(partial_arg$1, param);
                  });
              }
            })
        ]);
