...
function run(grp, parents) {
  ...
  var iter = function (state, tests) {
    if (tests) {
      var rest = tests[1];
      var partial_arg = runExample(groupStack, tests[0]);
      return (function (param) {
          return Respect_async.bind((function (result) {
  ...
  var partial_arg = iter(/* TestSucceeded */1, grp[/* examples */3]);
  return (function (param) {
      return Respect_async.bind((function (exampleResults) {
