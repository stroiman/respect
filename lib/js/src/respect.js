...
var empty$1 = /* record */[/* testResult : TestSucceeded */1];

function recordResult(result, carry) {
  return /* record */[/* testResult */mergeResult(result, carry[/* testResult */0])];
}

function merge(a, b) {
  return /* record */[/* testResult */mergeResult(a[/* testResult */0], b[/* testResult */0])];
}
