...
var Respect_dsl$Stroimanrespect = require("./Respect_dsl.js");
...
function runExample(groupStack, ex) {
  ...
  var md = List.fold_left(Respect_ctx$Stroimanrespect.ContextMap[/* merge */23], Respect_ctx$Stroimanrespect.ContextMap[/* empty */0], mdStack$prime);
  var ctx = Respect_ctx$Stroimanrespect.create(md);
...
function runRoot() {
  return run(Respect_dsl$Stroimanrespect.rootContext[0], /* [] */0);
}
