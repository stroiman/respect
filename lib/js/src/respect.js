...
function recordResult(result, carry) {
  var tmp_000 = /* testResult */mergeResult(result, carry[/* testResult */0]);
  var tmp_001 = /* noOfPassed */carry[/* noOfPassed */1];
  var tmp_002 = /* noOfPending */carry[/* noOfPending */2];
  var tmp_003 = /* noOfFailed */carry[/* noOfFailed */3];
  switch (result) {
    case 0 : 
        return /* record */[
                tmp_000,
                tmp_001,
                /* noOfPending */tmp_002 + 1 | 0,
                tmp_003
              ];
    case 1 : 
        return /* record */[
                tmp_000,
                /* noOfPassed */tmp_001 + 1 | 0,
                tmp_002,
                tmp_003
              ];
    case 2 : 
...
function merge(a, b) {
  return /* record */[
          /* testResult */mergeResult(a[/* testResult */0], b[/* testResult */0]),
          /* noOfPassed */a[/* noOfPassed */1] + b[/* noOfPassed */1] | 0,
          /* noOfPending */a[/* noOfPending */2] + b[/* noOfPending */2] | 0,
          /* noOfFailed */a[/* noOfFailed */3] + b[/* noOfFailed */3] | 0
        ];
}

function getNoOfPassedTests(x) {
  return x[/* noOfPassed */1];
}

function getNoOfPendingTests(x) {
  return x[/* noOfPending */2];
}

function getNoOfFailedTests(x) {
  return x[/* noOfFailed */3];
}
