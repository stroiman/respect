...
function create(metaData) {
  if (!class_tables[0]) {
    ...
    CamlinternalOO.set_methods($$class, /* array */[
          ...
          tryGet,
          (function (self$1, key) {
              var match = Curry._2(mem, key, self$1[data]);
              if (match !== 0) {
                return /* Some */[Curry._2(self$1[0][get], self$1, key)];
              } else {
                return /* None */0;
              }
            }),
...
function setSubj(fn, ctx) {
  return Caml_oo_curry.js2(299952044, 3, ctx, fn);
}

function subject(ctx) {
  return Caml_oo_curry.js2(696779180, 4, ctx, /* () */0);
}

function tryGet(key, ctx) {
  return Caml_oo_curry.js2(-716896741, 5, ctx, key);
}

function map(key, f, ctx) {
  var updated = Curry._1(f, get(key, ctx));
  return add$1(key, updated, ctx);
}

function don(ctx) {
  return Caml_oo_curry.js2(4997763, 6, ctx, /* () */0);
}
