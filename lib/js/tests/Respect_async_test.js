...
Respect_dsl.Async[/* register */3](Respect_dsl.Async[/* describe */2]("Async module", /* :: */[
          Respect_dsl.Async[/* describe */2]("return", /* :: */[
                Respect_dsl.Async[/* it */1]("eventually returns the value", (function () {
                        var partial_arg = TestHelpers.AsyncMatchers[/* asyncResolve */0];
          ...
          /* :: */[
            Respect_dsl.Async[/* describe */2]("map", /* :: */[
                  Respect_dsl.Async[/* it */1]("eventually returns the modified value", (function () {
                          var partial_arg = TestHelpers.AsyncMatchers[/* asyncResolve */0];
                          var partial_arg$1 = function (param, param$1) {
                            return Respect_matcher.$great$eq$great(partial_arg, (function (param) {
                  ...
                  /* :: */[
                    Respect_dsl.Async[/* it */1]("eventually returns error if mapping function throws", (function () {
                            var partial_arg = TestHelpers.AsyncMatchers[/* asyncThrow */1];
                            var partial_arg$1 = function (param, param$1) {
                              return Respect_matcher.$great$eq$great(partial_arg, (function (param) {
            ...
            /* :: */[
              Respect_dsl.Async[/* describe */2]("bind", /* :: */[
                    Respect_dsl.Async[/* it */1]("eventually returns the bound value", (function () {
                            var partial_arg = TestHelpers.AsyncMatchers[/* asyncResolve */0];
                            var partial_arg$1 = function (param, param$1) {
                              return Respect_matcher.$great$eq$great(partial_arg, (function (param) {
                                            return Respect_matcher.equal(43, param);
                    ...
                    /* :: */[
                      Respect_dsl.Async[/* it */1]("eventually returns error if bound function throws", (function () {
                              var partial_arg = TestHelpers.AsyncMatchers[/* asyncThrow */1];
                              var partial_arg$1 = function (param, param$1) {
                                return Respect_matcher.$great$eq$great(partial_arg, (function (param) {
                                              return Respect_matcher.equal(Dummy, param);
              ...
              /* :: */[
                Respect_dsl.Async[/* describe */2]("from_callback", /* :: */[
                      Respect_dsl.Async[/* it */1]("creates an async that succeeds", (function () {
                              var partial_arg = TestHelpers.AsyncMatchers[/* asyncResolve */0];
                              var partial_arg$1 = function (param, param$1) {
                                return Respect_matcher.$great$eq$great(partial_arg, (function (param) {
                                              return Respect_matcher.equal(42, param);
                ...
                /* :: */[
                  Respect_dsl.Async[/* describe */2]("Timeout", /* :: */[
                        Respect_dsl.Async[/* it */1]("fails when timeout exceeded", (function () {
                                ...
                                var partial_arg = Async.timeout(/* MilliSeconds */Block.__(0, [0]), after);
                                var partial_arg$1 = TestHelpers.AsyncMatchers[/* asyncThrow */1];
                        ...
                        /* :: */[
                          Respect_dsl.Async[/* it */1]("Succeeds when timeout not exceeded", (function () {
                                  var after = function (param) {
                                    var cb = param[0];
                                    setTimeout((function () {
                                            return Curry._1(cb, 42);
                                  ...
                                  var partial_arg = Async.timeout(/* MilliSeconds */Block.__(0, [10]), after);
                  ...
                  /* :: */[
                    Respect_dsl.Async[/* describe */2]("tryCatch", /* :: */[
                          Respect_dsl.Async[/* it */1]("async resolve Some value", (function () {
                                  var partial_arg = TestHelpers.AsyncMatchers[/* asyncThrow */1];
                                  var partial_arg$1 = function (param, param$1) {
                                    return Respect_matcher.$great$eq$great(partial_arg, (function (param) {
                          ...
                          /* :: */[
                            Respect_dsl.Async[/* it */1]("async throws None value", (function () {
                                    var partial_arg = TestHelpers.AsyncMatchers[/* asyncResolve */0];
                                    var partial_arg$1 = function (param, param$1) {
                                      return Respect_matcher.$great$eq$great(partial_arg, (function (param) {
                                                    return Respect_matcher.equal(42, param);
                    ...
                    /* :: */[
                      Respect_dsl.Async[/* describe */2]("mapping from async js functions", /* :: */[
                            Respect_dsl.Async[/* it */1]("handles JS errors nicely", (function () {
                                    var partial_arg = /* Some */["dummy"];
                                    var partial_arg$1 = function (param) {
                                      return haveMessage(partial_arg, param);
                                    };
                                    var partial_arg$2 = TestHelpers.AsyncMatchers[/* asyncThrow */1];
                            ...
                            /* :: */[
                              Respect_dsl.Async[/* it */1]("also handles when no error occues", (function () {
                                      var partial_arg = TestHelpers.AsyncMatchers[/* asyncResolve */0];
                                      var partial_arg$1 = function (param, param$1) {
                                        return Respect_matcher.$great$eq$great(partial_arg, (function (param) {
                                                      return Respect_matcher.equal(42, param);
