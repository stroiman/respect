...
Respect.Dsl[/* register */10](Respect.Dsl[/* describe */5]("Runner", /* :: */[
          Respect.Dsl[/* describe */5]("Group has a setup", /* :: */[
                Respect.Dsl[/* it_w */4]("Doesn't execute example code when setup code fails", (function (_, don) {
                        var lines = [/* [] */0];
                        ...
                        return Respect.Runner[/* run */2](ex, (function () {
                ...
                /* :: */[
                  Respect.Dsl[/* it_w */4]("Executes multiple setups before the example", (function (_, don) {
                          var lines = [/* [] */0];
                          var append = function (line) {
                            lines[0] = Pervasives.$at(lines[0], /* :: */[
                                  line,
                  ...
                  /* :: */[
                    Respect.Dsl[/* it_w */4]("Executes the setup code before the example", (function (_, don) {
                            var lines = [/* [] */0];
                            var append = function (line) {
                              lines[0] = Pervasives.$at(lines[0], /* :: */[
                                    line,
                    ...
                    /* :: */[
                      Respect.Dsl[/* describe */5]("Group has two examples", /* :: */[
                            Respect.Dsl[/* it_w */4]("Runs the setup before each example", (function (_, don) {
                                    var lines = [/* [] */0];
                                    var append = function (line) {
                                      lines[0] = Pervasives.$at(lines[0], /* :: */[
                                            line,
                      ...
                      /* :: */[
                        Respect.Dsl[/* describe */5]("Nested groups", /* :: */[
                              Respect.Dsl[/* it_w */4]("Runs the setups from outermost to innermost group", (function (_, don) {
                                      var lines = [/* [] */0];
                                      var append = function (line) {
                                        lines[0] = Pervasives.$at(lines[0], /* :: */[
                                              line,
                                      ...
                                      return Respect.Runner[/* run */2](outerGroup, (function () {
                                                    var partial_arg = lines[0];
                                                    return (function (param) {
          ...
          /* :: */[
            Respect.Dsl[/* describe */5]("ExampleGroup has metadata", /* :: */[
                  Respect.Dsl[/* it_w */4]("Initializes the metadata on the test context", (function (_, don) {
                          var lines = [/* [] */0];
                          var append = function (line) {
                            lines[0] = Pervasives.$at(lines[0], /* :: */[
                                  line,
                          ...
                          return Respect.Runner[/* run */2](grp, (function () {
                                        var partial_arg = lines[0];
                                        return (function (param) {
                                                    return Respect_matcher.shoulda((function (param) {
                                                                  return Respect_matcher.equal(/* :: */[
            ...
            /* :: */[
              Respect.Dsl[/* describe */5]("Parent group has metadata", /* :: */[
                    Respect.Dsl[/* it_w */4]("uses the metadata closest to the example", (function (_, don) {
                            var lines = [/* [] */0];
                            var append = function (line) {
                              lines[0] = Pervasives.$at(lines[0], /* :: */[
                                    line,
              ...
              /* :: */[
                Respect.Dsl[/* describe */5]("example throws an exception", /* :: */[
                      Respect.Dsl[/* it_w */4]("returns an error message", (function (_, don) {
                              ...
                              return Respect.Runner[/* run */2](ex, (function (param) {
                                            if (param !== 0) {
                ...
                /* :: */[
                  Respect.Dsl[/* it */2]("executes the example code", (function () {
                          var lines = [/* [] */0];
                          var ex = Curry._1(TestHelpers.withExampleCode((function () {
                                      var line = "x";
                                      lines[0] = /* :: */[
                          ...
                          Respect.Runner[/* run */2](ex, (function () {
                                  return /* () */0;
                                }));
                          var partial_arg = /* :: */[
                            "x",
                          ...
                          return Respect_matcher.should((function (param) {
                                        return Respect_matcher.equal(partial_arg, param);
                                      }), lines[0]);
                        })),
                  /* [] */0
                ]
