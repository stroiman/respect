...
function beSuccess(actual) {
  var match = Curry._1(Respect.Runner[/* RunResult */2][/* getResult */6], actual);
  if (match !== 1) {
    return (function (param) {
...
Respect_dsl.Async[/* register */3](Respect_dsl.Async[/* describe */2]("Runner", /* :: */[
          Respect_dsl.Async[/* describe */2]("Group has 3 passing, two pending, and one failing test", /* :: */[
                Respect_dsl.Async[/* beforeEach */4]((function (ctx, don) {
                        ...
                        return Respect_async.run(/* None */0, (function (x) {
                ...
                /* :: */[
                  Respect_dsl.Async[/* it */1]("reports 3 passed", (function (ctx) {
                          var partial_arg = Curry._1(Respect.Runner[/* RunResult */2][/* getNoOfPassedTests */3], Respect_ctx.get("result", ctx));
                          return (function (param) {
