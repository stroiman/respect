...
function anExampleWithCode(fn) {
  return /* record */[
          ...
          /* func */(function (param, param$1) {
              return Respect_dsl$Stroimanrespect.wrapTest(fn, param, param$1);
            }),
          /* metadata */Respect_ctx$Stroimanrespect.ContextMap[/* empty */0]
        ];
}

var anExampleGroup = Respect_domain$Stroimanrespect.ExampleGroup[/* empty */0];

var withAnExample = Respect_domain$Stroimanrespect.ExampleGroup[/* addExample */2];
...
function withMetadata(param, grp) {
  return /* record */[
          ...
          /* metadata */Curry._3(Respect_ctx$Stroimanrespect.ContextMap[/* add */3], param[0], param[1], grp[/* metadata */4])
        ];
}

function withSetup(code) {
  var partial_arg = /* Setup */[code];
  var partial_arg$1 = Respect_domain$Stroimanrespect.ExampleGroup[/* addSetup */3];
  return (function (param) {
...
function withChildGroup(child, grp) {
  return Respect_domain$Stroimanrespect.ExampleGroup[/* addChild */1](child, grp);
}
...
function withExample(metadata, $staropt$star, $staropt$star$1, grp) {
  ...
  if (metadata) {
    ...
    md = Curry._3(Respect_ctx$Stroimanrespect.ContextMap[/* add */3], match[0], match[1], Respect_ctx$Stroimanrespect.ContextMap[/* empty */0]);
  } else {
    md = Respect_ctx$Stroimanrespect.ContextMap[/* empty */0];
  }
  var ex = /* record */[
    /* name */name,
    /* func */code,
  ...
  return Respect_domain$Stroimanrespect.ExampleGroup[/* addExample */2](ex, grp);
}
...
/* Respect_ctx-Stroimanrespect Not a pure module */
